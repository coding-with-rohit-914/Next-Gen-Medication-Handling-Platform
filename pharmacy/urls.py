...
from .import pharmacistViews,DoctorViews,views,patient_view,clerkViews, resetpass_views
...
urlpatterns=[
    ...
    path('forgot-password/', resetpass_views.forgot_password, name='forgot_password'),
    path('verify-otp/', resetpass_views.verify_otp, name='verify_otp'),
    path('reset-password/', resetpass_views.reset_password, name='reset_password'),
